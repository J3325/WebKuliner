...
<body>
    <div class="container mt-5">
        <h2 class="text-center mb-4">What's Your Drink?</h2>
        <div class="card mx-auto" style="max-width: 40rem;">
            <div class="card-body">
                <h5 class="card-title text-center">Add New Drink</h5>
                <form method="post" action="?page=minumanAddProses">
                    <div class="mb-3">
                        <label for="namaMinuman" class="form-label d-block text-start">Name Drink</label>
